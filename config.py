...
class TrainConfig:
    ...
    n_min:        int   = field(default_factory=lambda: _env('N_MIN',       5))
    k:            float = field(default_factory=lambda: _env('K',           2.5))
    ewma_lambda:  float = field(default_factory=lambda: _env('EWMA_LAMBDA', 0.25))
    ...
    sleep_prob_off:       float = field(default_factory=lambda: _env('SLEEP_PROB_OFF',       0.10))
    sleep_check_interval: int   = field(default_factory=lambda: _env('SLEEP_CHECK_INTERVAL', 10))
    sleep_duration_ratio: float = field(default_factory=lambda: _env('SLEEP_DURATION_RATIO', 2.0))
