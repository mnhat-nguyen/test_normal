...
class TrainConfig:
    ...
    sleep_prob_on:        float = field(default_factory=lambda: _env('SLEEP_PROB_ON',        0.40))
    ...
    sleep_duration_ratio: float = field(default_factory=lambda: _env('SLEEP_DURATION_RATIO', 0.05))
